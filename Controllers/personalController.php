...
switch ($request) {
    case 'GET':
        if (isset($_GET['alumnos']) and $_GET['alumnos'] == 'todos') {
            $stmt = $personal->leerTodosLosAlumnos();
            $num = $stmt->rowCount();
            ...
            if ($num > 0) {
                ...
                while ($result = $stmt->fetch()) {
                    $response["data"][] = array(
                        ...
                        "habilidadesBlandas" => $result->habilidadesBlandas,
                        "habilidadesDuras" => $result->habilidadesDuras,
